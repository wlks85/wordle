...
(function (factory) {
    ...
    var Input = /** @class */ (function () {
        function Input(gestionnaire, configuration, longueurMot, premiereLettre) {
            ...
            this._haptiqueActive = (_a = configuration.haptique) !== null && _a !== void 0 ? _a : configuration_1.default.Default.haptique;
        ...
        Input.prototype.dessinerClavier = function (disposition) {
            ...
            this._haptiqueActive = (_b = (_a = sauvegardeur_1.default.chargerConfig()) === null || _a === void 0 ? void 0 : _a.haptique) !== null && _b !== void 0 ? _b : configuration_1.default.Default.haptique;
            ...
            for (var _i = 0, _a = this._resultats; _i < _a.length; _i++) {
                ...
                for (var positionResultat in resultat) {
                    ...
                    if (lettreResultat.statut === lettreStatut_1.LettreStatut.BienPlace)
                        lettrePrerempli[positionResultat] = { preRempli: true, lettre: lettreResultat.lettre };
                }
            }
            if (lettrePrerempli.every(function (lettre) { return lettre.preRempli; })) {
                return { preRempli: true, mot: lettrePrerempli.reduce(function (mot, lettre) { return mot + lettre.lettre; }, "") };
            }
