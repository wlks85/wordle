...
(function (factory) {
    ...
    var motDeDescriptionPanel_1 = __importDefault(require("./motDeDescriptionPanel"));
    var Gestionnaire = /** @class */ (function () {
        function Gestionnaire() {
            ...
            this._motDeDescriptionPanel = new motDeDescriptionPanel_1.default(this._datePartieEnCours, this._panelManager, this);
        ...
        Gestionnaire.prototype.discoverDescription = function (mot) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this._motDeDescriptionPanel.discover(mot)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
