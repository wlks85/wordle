...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "express", "../../lib/AsyncExceptionWrapper", "../services/DictionaryService"], factory);
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, DictionaryService_1.DictionaryService.getWordByName(keyword)];
                case 1:
                    word = _a.sent();
                    res.json({ data: word });
                    return [2 /*return*/];
    ...
    WordDescriptionController.post("/", (0, AsyncExceptionWrapper_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var payload, word;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    exports.default = WordDescriptionController;
});
