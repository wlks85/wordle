...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../entities", "./DictionaryService"], factory);
    }
    ...
    var DictionaryService_1 = require("./DictionaryService");
        ...
        DictionaryService.saveAWord = function (word) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(0, DictionaryService_1.validateWord)(word))
                                throw new Error("400- Bad request");
                            dbWord = new entities_1.WordModel(__assign({ title: word.title.toUpperCase() }, word));
