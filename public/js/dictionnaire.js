                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, (_b = "./mots/listeMotsProposables.".concat(longueur, ".").concat(premiereLettre), __syncRequire ? Promise.resolve().then(function () { return __importStar(require(_b)); }) : new Promise(function (resolve_1, reject_1) { require([_b], resolve_1, reject_1); }).then(__importStar))];
                                        case 1:
                                            _ = _a.sent();
                                            return [2 /*return*/, mot];
                                    }
