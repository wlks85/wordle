...
export default class MotDeDescriptionPanel {
    ...
    public async discover(mot: string): Promise<void> {
        this._mot = mot;
        this._motDescription = await this.getWordDescription(mot);
    ...
    public async afficher() {
        ...
        <div class="word-description">
            <div class="word-description title">${this._mot}</div>
            <div class="word-description desc">${this._motDescription}</div>
        </div>
        `;
